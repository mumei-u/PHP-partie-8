...
if (isset($_COOKIE['login']) && isset($_COOKIE['password'])) {
    setcookie('login', 'identifiant', time() + 365 * 24 * 3600, '/');
    setcookie('password', 'MDP', time() + 365 * 24 * 3600, '/');
}
?>
<!DOCTYPE html>
<html lang="fr" dir="ltr">
    ...
    <body>
        <div class="container text-center bg-secondary">
            <h1 class="text-light">PHP | P8-ex5</h1>
            <nav>
        ...
        <div class="container text-center">
            ...
            <p>Login : <?php echo $_COOKIE['login'] ?> <br> Password : <?php echo $_COOKIE['password'] ?></p>
        </div>
